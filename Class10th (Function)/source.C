...
inline int square(int x) // 인라인 함수는 요청만 하는 함수입니다.
{
	return x * x;

	// 호출하는 과정이 없으므로 인라인 함수에서 
	// return을 이용하여 연산을 한 다음
	// main 함수 안에서 출력만 하면 값이 나옵니다.
}
...
//	double sum1 = average(3, 6, 12, 9);
//	double sum2 = average(3, 6, 21, 12);
//
//	printf("평균 : %lf\n", sum1);
//	printf("평균 : %lf\n", sum2);
